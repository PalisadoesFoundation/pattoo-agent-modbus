...
if EXEC_DIR.endswith('/pattoo-agent-modbus/setup') is True:
...
Other steps:
    1) You can make the various pattoo agents be system daemons by running the
       ...
       https://github.com/PalisadoesFoundation/pattoo-agent-modbus/tree/master/setup/systemd
