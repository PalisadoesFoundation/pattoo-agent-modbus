#!/usr/bin/env python3
"""Script to test all the pattoo-agent-modbus unittests.
...
_EXPECTED = '{0}pattoo-agent-modbus{0}tests{0}bin'.format(os.sep)
...
def main():
    """Test all the pattoo-agent-modbus modules with unittests.
...
def run_script(cli_string):
    ...
    pattoo_returncode = ('----- pattoo-agent-modbus Return Code '
                         '----------------------------------------')
    pattoo_stdoutdata = ('----- pattoo-agent-modbus Test Output '
                         '----------------------------------------')
    pattoo_stderrdata = ('----- pattoo-agent-modbus Test Error '
                         '-----------------------------------------')
