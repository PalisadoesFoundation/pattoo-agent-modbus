...
_EXPECTED = ('''\
{0}pattoo-agent-modbus{0}tests{0}pattoo_agent_modbus_{0}tcp'''.format(os.sep))
...
# Pattoo imports
from pattoo_agent_modbus.tcp import configuration
from pattoo_agent_modbus.variables import (
