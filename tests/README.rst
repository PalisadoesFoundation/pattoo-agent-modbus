...
Welcome to the developer testing section of ``pattoo-agent-modbus``.
...
``pattoo-agent-modbus`` tries to make it easy for developers and users to see where there are issues in the code, operating conditions or configuration by generously logging events.
