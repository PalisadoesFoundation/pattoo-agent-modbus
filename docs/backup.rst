...
#. The ``pattoo-agent-modbus`` directory which contains your source code.
...
It's important to follow these steps in this order when restoring ``pattoo-agent-modbus`` after a disaster.
...
#. Restore ``pattoo-agent-modbus`` directory which contains your source code.
